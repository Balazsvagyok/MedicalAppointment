...
public class MainActivity extends AppCompatActivity {
    ...
    public void loginAsGuest(View view) {
        mAuth.signInAnonymously().addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Log.d(LOG_TAG, "Sikeres anonymous bejelentkezés!");
                    startAppointment();
                } else {
                    Log.e(LOG_TAG, "Sikertelen anonymous bejelentkezés!");
                    Toast.makeText(MainActivity.this, "Sikertelen anonymous bejelentkezés!"
                            + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void loginWithGoogle(View view) {
        // TODO: Google bejelentkezés megvalósítása (5. rész végén)
    }
